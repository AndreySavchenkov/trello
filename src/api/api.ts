...
const instance = axios.create({
  ...
  headers: { Authorization: `Token eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwidXNlcm5hbWUiOiJ0ZXN0IiwiZW1haWwiOiJ0ZXN0QGdtYWlsLmNvbSIsImlhdCI6MTY0OTg0NDcxNX0.IcGjRUwUKo4syLRxBFN8G06jKvI_PNPJSAi6H4DIyq0` },
});
...
export const userApi = {
  ...
  registerUser(username: string,email: string, password: string){
    return instance.post<CurrenUserResponseT>(`/user/register`,{ username, email, password });
  },
